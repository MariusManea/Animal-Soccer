...
public class Dead_Ball : MonoBehaviour {
	...
	void Update () {
		...
		if (triggered) {
			anim_writer.SetInteger ("Writing", 2);
			ball.GetComponent<Ball> ().dead = true;
			ball.GetComponent<Ball> ().bouncy = false;
			ball.GetComponent<Ball> ().time_dead = Time.time;
